...
* Usage
  ...
  {{{http://docs.codehaus.org/display/MAVENUSER/Verifier+Plugin}plugin's wiki page}}.
...
* Examples
  ...
  To provide you with better understanding on some usages of the Verifier Plugin,
